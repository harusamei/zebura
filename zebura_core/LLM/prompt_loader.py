        ...
        if style == 'lite':
            ...
            for table_name in tableList:
                ...
                for column in columns:
                    if style == 'full':
                        tList.append(
                            f"{column['column_name']}: {column.get('desc', '')} (Alias: {column.get('name', '')}, {column.get('alias', '')})\n")
                    elif style == 'zh':
                        tList.append(
                            f"{column.get('column_name', '')}: {column.get('desc', '')} (Alias: {column.get('name_zh', '')}, {column.get('alias_zh', '')})\n")
